...
lub w konsoli na ubuntu to wpisujemy polecenie: mvn clean package jetty:run
...
Dodatkowo, je¿eli mamy zainstalowany serwer Tomcat, to projekt powinien odpalic siê po wpisaniu polecenia: mvn clean package tomcat:run
